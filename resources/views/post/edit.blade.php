<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="mx-4 sm:p-8">
            {{-- updateメソッドに処理が行くようにルーティングする --}}
            <form method="post" action="{{route('post.update', $post)}}" enctype="multipart/form-data">
                @csrf
                {{-- formタグのmethodには、パッチ方式はないため、@methodで指定する --}}
                @method('patch')
                <div class="md:flex items-center mt-8">
                    <div class="w-full flex flex-col">
                    <label for="body" class="font-semibold leading-none mt-4">件名</label>
                    {{-- valueの中のold関数の第2引数に、$post->titleと入力することで、対象のidのtitleを取得することが可能 --}}
                ...
                <div class="w-full flex flex-col">
                    ...
                    {{-- valueの中のold関数の第2引数に、$post->bodyと入力することで、対象のidのbody（本文）を取得することが可能 --}}
